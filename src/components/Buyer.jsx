...
export default function Buyer() {
    ...
    useEffect(() => {
        async function getAds() {
            try {
                const res = await axios.get('http://3a2e-2405-201-1b-3826-79bd-3761-f15e-444d.ngrok.io/advertisements')
    ...
    return (
        <div>
            <div className="container mt-5">
                <form>
                    <input className="form-control form-control-lg" type="text" placeholder="Search property as per type, city, BHKs" style={{ width: "780px", borderRadius: "25px" }} value={Search} onChange={searchHandler} />
                </form>
                <div>
                    <div className="row">
                        {Ads && Ads.filter((val) => {
                            ...
                            return (
                                <div className="mt-3" key={ourAds.id}>
                                        <div className="card" style = {{width:"800px", borderRadius:"10px"}}>
                                            <Link onClick={(e) => eventHandler(e, ourAds.id)} to = "/ad" style={{ textDecoration: "none", color: "black" }}>
                                            <div className="row">
                                                    ...
                                                    <div className="card-body">
                                                        ...
                                                        <div className="row">
                                                            <div className="col-6 col-sm-2">
                                                                <button type="button" className="btn btn-outline-primary mt-2" style={{ borderRadius: "15px" }}>{ourAds.bhk} BHK</button>
                                                            </div>
                                                            <div className="col-col-6 col-sm-2">
                                                                <button type="button" className="btn btn-outline-primary mt-2" style={{ borderRadius: "15px" }}>{ourAds.type}</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
